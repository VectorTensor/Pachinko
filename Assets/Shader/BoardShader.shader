        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
               ...
               float offset = cos(i.uv.x* TAU*8)*0.01;
                ...
                float4 moss = tex2D(_MainTex, float2(i.uv.x , i.uv.y));
               // t *= i.uv.x;
                //return t*_BaseColor;
                ...
                float rock = tex2D(_rock, i.uv.yx);
                rock = rock * _BaseColor;
               // return GetWave(i.uv);
               float4 terrain = lerp(moss,rock*_BaseColor,pattern);
