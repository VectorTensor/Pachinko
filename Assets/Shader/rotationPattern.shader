Shader "Examples/rotationPattern"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                //float2 timexy = cartesianToPolar(float2(_Time.y,0) );
                float4 textureSample = tex2D(_BaseTex,float2(radialUV.x, radialUV.y + _Time.y ));
